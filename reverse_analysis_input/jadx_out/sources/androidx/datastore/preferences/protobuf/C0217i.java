...
public final class C0217i extends AbstractC0218j {

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final InputStream f4155c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final byte[] f4156d;
    ...
    public int f4161j = Integer.MAX_VALUE;

    public C0217i(InputStream inputStream) {
        Charset charset = AbstractC0231x.f4217a;
        this.f4155c = inputStream;
        this.f4156d = new byte[4096];
        this.f4157e = 0;
        this.f4159g = 0;
        this.i = 0;
    }
    ...
    public final String A() throws C0233z {
        ...
        if (iM > 0) {
            ...
            int i5 = this.f4159g;
            if (iM <= i - i5) {
                String str = new String(bArr, i5, iM, AbstractC0231x.f4217a);
                this.f4159g += iM;
                return str;
            }
        }
        ...
        if (iM > this.f4157e) {
            return new String(H(iM), AbstractC0231x.f4217a);
        }
        Q(iM);
        String str2 = new String(bArr, this.f4159g, iM, AbstractC0231x.f4217a);
        this.f4159g += iM;
        return str2;
    }
    ...
    public final boolean F(int i) throws C0233z {
        ...
        int i7 = this.f4157e - this.f4159g;
        byte[] bArr = this.f4156d;
        if (i7 >= 10) {
            while (i6 < 10) {
                int i8 = this.f4159g;
    ...
    public final byte[] H(int i) throws IOException {
        ...
        System.arraycopy(this.f4156d, i5, bArr, 0, length);
    ...
    public final byte[] I(int i) throws IOException {
        ...
        if (i7 - Integer.MAX_VALUE > 0) {
            throw new C0233z("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
        }
        int i8 = this.f4161j;
        if (i7 > i8) {
            R((i8 - i5) - i6);
        ...
        int i9 = this.f4157e - i6;
        int i10 = i - i9;
        InputStream inputStream = this.f4155c;
        if (i10 >= 4096) {
            try {
        ...
        byte[] bArr = new byte[i];
        System.arraycopy(this.f4156d, this.f4159g, bArr, 0, i9);
        this.i += this.f4157e;
        this.f4159g = 0;
        this.f4157e = 0;
        while (i9 < i) {
    ...
    public final ArrayList J(int i) throws IOException {
        ...
        while (i > 0) {
            ...
            int i5 = 0;
            while (i5 < iMin) {
                int i6 = this.f4155c.read(bArr, i5, iMin - i5);
                if (i6 == -1) {
                    throw C0233z.e();
                }
                this.i += i6;
    ...
    public final int K() throws C0233z {
        int i = this.f4159g;
        if (this.f4157e - i < 4) {
            Q(4);
            i = this.f4159g;
    ...
    public final long O() throws C0233z {
        long j5 = 0;
    ...
    public final void Q(int i) throws C0233z {
        if (S(i)) {
            return;
        }
        if (i <= (Integer.MAX_VALUE - this.i) - this.f4159g) {
            throw C0233z.e();
        }
        throw new C0233z("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
    }

    public final void R(int i) throws C0233z {
        int i5 = this.f4157e;
        int i6 = this.f4159g;
        if (i <= i5 - i6 && i >= 0) {
            this.f4159g = i6 + i;
    ...
    public final boolean S(int i) throws IOException {
        ...
        int i8 = this.i;
        if (i > (Integer.MAX_VALUE - i8) - i5 || i8 + i5 + i > this.f4161j) {
            return false;
        }
        byte[] bArr = this.f4156d;
        if (i5 > 0) {
    ...
    @Override // androidx.datastore.preferences.protobuf.AbstractC0218j
    public final int f() {
        return this.i + this.f4159g;
    }

    @Override // androidx.datastore.preferences.protobuf.AbstractC0218j
    public final boolean g() {
        return this.f4159g == this.f4157e && !S(1);
    }
    ...
    @Override // androidx.datastore.preferences.protobuf.AbstractC0218j
    public final C0215g n() throws IOException {
        int iM = M();
        int i = this.f4157e;
        int i5 = this.f4159g;
        int i6 = i - i5;
        byte[] bArr = this.f4156d;
        if (iM <= i6 && iM > 0) {
            C0215g c0215gH = C0215g.h(bArr, i5, iM);
            this.f4159g += iM;
            return c0215gH;
        }
        if (iM == 0) {
            return C0215g.f4144n;
        }
        if (iM < 0) {
            throw C0233z.d();
        }
        byte[] bArrI = I(iM);
        if (bArrI != null) {
            return C0215g.h(bArrI, 0, bArrI.length);
        }
        int i7 = this.f4159g;
        int i8 = this.f4157e;
        int length = i8 - i7;
